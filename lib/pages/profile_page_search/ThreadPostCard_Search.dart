...
import 'package:rendi_art/pages/home_page/komentar.dart';

class ThreadPostCardSearch extends StatefulWidget {
  final DocumentSnapshot document;
  final String currentUserId;

  ThreadPostCardSearch({required this.document, required this.currentUserId});

  @override
  _ThreadPostCardSearchState createState() => _ThreadPostCardSearchState();
}

class _ThreadPostCardSearchState extends State<ThreadPostCardSearch> {
  bool isLoved = false;
          ...
          ListTile(
            ...
            trailing: Row(
              ...
              children: <Widget>[
                IconButton(
                  icon: const Icon(
                      Icons.comment), // Ini adalah ikon untuk komentar
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => KomentarPage(
                            document: widget
                                .document), // Ini adalah halaman yang dibuka saat widget diklik
                      ),
                    );
                  },
                ),
